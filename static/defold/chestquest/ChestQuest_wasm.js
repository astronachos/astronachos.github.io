...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmTable = wasmExports["ai"];
    addOnInit(wasmExports["Xh"]);
...
var wasmImports = {
  b: ___assert_fail,
  Wh: ___syscall__newselect,
  Vh: ___syscall_accept4,
  Uh: ___syscall_bind,
  Th: ___syscall_connect,
  Sh: ___syscall_dup3,
  j: ___syscall_fcntl64,
  Rh: ___syscall_getpeername,
  Qh: ___syscall_getsockname,
  sa: ___syscall_getsockopt,
  Ph: ___syscall_ioctl,
  Oh: ___syscall_listen,
  Nh: ___syscall_mkdirat,
  ra: ___syscall_openat,
  Mh: ___syscall_poll,
  Lh: ___syscall_readlinkat,
  Kh: ___syscall_recvfrom,
  Jh: ___syscall_renameat,
  Ih: ___syscall_rmdir,
  Hh: ___syscall_sendto,
  Ia: ___syscall_socket,
  Gh: ___syscall_stat64,
  qa: ___syscall_unlinkat,
  Dh: __emscripten_get_now_is_monotonic,
  Ch: __emscripten_lookup_name,
  Bh: __emscripten_system,
  ...
  oh: _dmSysOpenURL,
  Ga: _emscripten_asm_const_double,
  ...
  _b: _glColorMask,
  C: _glCompileShader,
  t: _glCompressedTexImage2D,
  Da: _glCompressedTexImage3D,
  s: _glCompressedTexSubImage2D,
  Zb: _glCompressedTexSubImage3D,
  aa: _glCreateProgram,
  N: _glCreateShader,
  Yb: _glCullFace,
  $: _glDeleteBuffers,
  Xb: _glDeleteFramebuffers,
  B: _glDeleteProgram,
  r: _glDeleteRenderbuffers,
  A: _glDeleteShader,
  M: _glDeleteTextures,
  Wb: _glDeleteVertexArraysOES,
  Vb: _glDepthFunc,
  Ub: _glDepthMask,
  Ca: _glDetachShader,
  n: _glDisable,
  ...
  Qb: _glFlush,
  Pb: _glFramebufferRenderbuffer,
  Ob: _glFramebufferTexture2D,
  Nb: _glFrontFace,
  Z: _glGenBuffers,
  Mb: _glGenFramebuffers,
  L: _glGenRenderbuffers,
  Y: _glGenTextures,
  Lb: _glGenVertexArraysOES,
  Kb: _glGetActiveAttrib,
  ...
  y: _glShaderSource,
  Eb: _glStencilFunc,
  Db: _glStencilFuncSeparate,
  Cb: _glStencilMask,
  Bb: _glStencilOp,
  Ab: _glStencilOpSeparate,
  m: _glTexImage2D,
  zb: _glTexImage3D,
  yb: _glTexParameterf,
  l: _glTexParameteri,
  ...
  fa: _glViewport,
  vb: _glfwAccelerometerEnable,
  ub: _glfwCloseWindow,
  tb: _glfwDisable,
  sb: _glfwEnable,
  rb: _glfwGetAcceleration,
  xa: _glfwGetDefaultFramebuffer,
  qb: _glfwGetDisplayScaleFactor,
  pb: _glfwGetJoystickButtons,
  ob: _glfwGetJoystickDeviceId,
  nb: _glfwGetJoystickHats,
  T: _glfwGetJoystickParam,
  mb: _glfwGetJoystickPos,
  lb: _glfwGetKey,
  k: _glfwGetMouseButton,
  kb: _glfwGetMouseLocked,
  jb: _glfwGetMousePos,
  ib: _glfwGetMouseWheel,
  hb: _glfwGetWindowParam,
  gb: _glfwGetWindowRefreshRate,
  wa: _glfwGetWindowSize,
  fb: _glfwIconifyWindow,
  eb: _glfwInitJS,
  va: _glfwOpenWindow,
  I: _glfwOpenWindowHint,
  db: _glfwPollEvents,
  cb: _glfwResetKeyboard,
  bb: _glfwSetCharCallback,
  ab: _glfwSetDeviceChangedCallback,
  $a: _glfwSetGamepadCallback,
  _a: _glfwSetMarkedTextCallback,
  Za: _glfwSetTouchCallback,
  Ya: _glfwSetWindowBackgroundColor,
  Xa: _glfwSetWindowCloseCallback,
  Wa: _glfwSetWindowFocusCallback,
  Va: _glfwSetWindowIconifyCallback,
  Ua: _glfwSetWindowSize,
  Ta: _glfwSetWindowSizeCallback,
  Sa: _glfwSetWindowTitle,
  S: _glfwShowKeyboard,
  Ra: _glfwSwapBuffers,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Xh"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Yh"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Zh"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["_h"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["$h"])(a0);
};
var _defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = function (a0) {
  return (_defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = wasmExports["bi"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["ci"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["di"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["ei"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["fi"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["gi"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["hi"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["ii"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["ji"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["ki"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["li"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["mi"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["ni"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["oi"])(a0, a1);
};
var ___start_em_js = Module["___start_em_js"] = 424089;
var ___stop_em_js = Module["___stop_em_js"] = 424484;
